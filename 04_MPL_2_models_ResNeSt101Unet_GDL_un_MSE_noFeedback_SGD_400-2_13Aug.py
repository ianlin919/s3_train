...
class MPL:
    def __init__(self,
        ...
        self.train_dataset_u = ImageDataSet2(labeled_txt_path=train_txt_path,
                                             ...
                                             img_dir=img_dir,
                                             transform=RandAugment_senior_13(1, 20))
    ...
    def train(self, epoch):
        ...
        with tqdm(total=len(self.train_dataset_u), desc="train ", unit="img",
            ...
            for (imgs, labels), (un_w, un_s) in zip(cycle(self.train_loader_l), self.train_loader_u):
                ...
                cons_loss = self.cons_weight * self.un_loss(torch.sigmoid(pred_s), torch.sigmoid(pred_w.detach()) * mask) # pred_w.detach() * mask
...
if __name__ == "__main__":
    ...
    parser.add_argument("--un_loss", default=nn.MSELoss()) # nn.MSELoss()
    ...
    parser.add_argument("--s_dir", "--save_dir", default=Path("./record/04_MPL_2_models_ResNeSt101Unet_GDL_un_MSE_noFeedback_SGD_400-2_13Aug/5F_2"))
    ...
    parser.add_argument("--ms", "--student_model", default=smp.Unet("timm-resnest101e", in_channels=1, classes=1)) # timm-resnest101e
    ...
    parser.add_argument("--model_path", default="./record/04_MPL_2_models_ResNeSt101Unet_GDL_un_MSE_noFeedback_SGD_400-2_13Aug/5F_2/bestF1.pth")
